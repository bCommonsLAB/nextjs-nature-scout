...
> Hinweis: Dieses Kapitel ist jetzt Teil des Anwenderhandbuchs.
> Bitte verwenden Sie künftig:
> `docs/anwenderhandbuch/14-integration-geo-browser.md`

---

# Integration Geo‑Browser (Gemeindeverband) – JSON‑Export geschützter Habitate

Dieses Kapitel beschreibt ein **vorbereitendes, technisches Feature**:
In der Habitatverwaltung kann ein*e Administrator*in (bzw. generell Nutzer*innen mit erweiterten Rechten)
eine **JSON-Datei exportieren**, die **verifizierte** Habitate in einer flachen Struktur enthält.

Ziel ist, diese Datei dem Gemeindeverband zu übermitteln, damit sie im **Geo‑Browser** ausgespielt wird
und öffentlich Bedienstete Zugriff auf die Informationen erhalten.
...
- `docs/samples/habitat-export-2025-12-30.json`
